...
export class News extends Component {
    ...
    constructor(props) {
        ...
        document.title = `${this.capitalizeFirstLetter(this.props.category)} - News Apk`;
    }
    ...
    render() {
        return (
            <>
                <h1 className='text-center mt-5 pt-4' style={{ margin: '35px' }}>Top {this.capitalizeFirstLetter(this.props.category)}  Headlines</h1>
